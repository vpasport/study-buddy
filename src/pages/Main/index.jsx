...
import { Chat, ModalMessage, Notes } from '../../components'
        ...
        <>
            <div className={styles.main}>
                ...
                <div className={styles.header}>
                    <p>Ученик: Паспортников Вячеслав</p>
                </div>
                ...
                <div className={styles.tools_bar}>
                    ...
                    <div className={styles.central_tools_bar}>
                        ...
                        <Button className={`p-button-danger ${styles.exit_button}`} onClick={() => setDisplay(true)}>
                            Завершить занятие
                        </Button>
                    </div>
            ...
            <ModalMessage display={display} setDisplay={setDisplay} type='teacher' />
        </>
    )
}
